<template>
    <div class="product-item">
        <a-card @click="routeLinkToProductDetail(props.product?.id)" hoverable style="padding: 10px; border: 1px solid gainsboro;">
            <template #cover>
                <img 
                    style="object-fit:contain; width: 210px; height: 263px;" 
                    :src="props.product?.image? props.product?.image : '/public/img/book_cover.png'" 
